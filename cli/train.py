...
def main(args):
    ...
    device = args.device
    # TASK 2.1 (1 point): if device is not specified, set it to "cuda" if torch.cuda.is_available()
    ...
    # TASK 2.2 (1 point): Create AdamW optimizer (not Adam)
    ...
    for _ in tqdm(range(args.max_epochs), desc="Epochs"):
        ...
        # TASK 2.3 (1 point): Compute the test accuracy at the end of every epoch
