...
def test_accuracy():
    ...
    ), f"computed accuracy {acc} is incorrect, expected {expected_acc}, got {acc}"
...
def test_accuracy_rand():
    ...
    assert 0 < acc < 1, f"for this random seed accuracy shouldn't be exactly 0 or 1, but you got {acc}"
